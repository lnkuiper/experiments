int_columns = ['c_birth_day', 'c_birth_month', 'c_birth_year', 'c_customer_sk', 'c_current_cdemo_sk', 'c_current_hdemo_sk', 'c_current_addr_sk', 'c_first_shipto_date_sk', 'c_first_sales_date_sk', 'c_last_review_date_sk']
