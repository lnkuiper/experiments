...
def main():
    ...
    cur = con.cursor()
    run(cur, '../../queries/tpcds/catalog_sales/sql/', f'../../results/postgres/tpcds/sf{sf}/catalog_sales/')
    run(cur, '../../queries/tpcds/customer/sql/', f'../../results/postgres/tpcds/sf{sf}/customer/')
