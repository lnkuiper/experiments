...
def main():
    ...
    con = pymonetdb.connect(username="monetdb", password="monetdb", hostname="localhost", port=50000, database="test")
    cursor = con.cursor()
	run(cursor, '../../queries/randints/sql/', '../../results/monetdb/randints/')
